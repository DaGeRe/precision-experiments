...
plot 'repetitionHeatmaps/noOutlierRemoval_100000_TTEST.csv' u 1:2:3 with image notitle

set yrange [0:50]
set title 'Parallel'
plot 'repetitionHeatmapsParallel/noOutlierRemoval_100000_TTEST.csv' u 1:2:3 with image notitle
